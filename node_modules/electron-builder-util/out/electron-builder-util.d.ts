...
declare module "electron-builder-util/out/macosVersion" {
  
  export function isMacOsSierra(): Promise<boolean>
}

declare module "electron-builder-util/out/bundledTool" {
...
declare module "electron-builder-util/out/wine" {
  ...
  /** @private */
  export function prepareWindowsExecutableArgs(args: Array<string>, exePath: string): string[]
...
declare module "electron-builder-util" {
  ...
  export { isMacOsSierra } from "electron-builder-util/out/macosVersion"
  ...
  export function isEnvTrue(value: string | null | undefined): boolean
}
