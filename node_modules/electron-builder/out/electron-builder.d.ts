...
declare module "electron-builder/out/util/asarUtil" {
  ...
  export function copyFileOrData(fileCopier: FileCopier, data: string | Buffer | undefined | null, source: string, destination: string, stats: Stats): Promise<void>
}
...
declare module "electron-builder/out/platformPackager" {
  ...
  import { Platform, Target, TargetSpecificOptions } from "electron-builder/out/core"
...
declare module "electron-builder/out/metadata" {
  ...
  import { Publish } from "electron-builder-http/out/publishOptions"
  import { Arch } from "electron-builder-util"
  import { BeforeBuildContext, CompressionLevel, Target, TargetConfig, TargetSpecificOptions } from "electron-builder/out/core"
...
declare module "electron-builder/out/targets/dmg" {
  import { Arch } from "electron-builder-util"
  import { Target } from "electron-builder/out/core"
...
declare module "electron-builder/out/targets/nsis/nsisUtil" {
  ...
  export function createMacro(name: string, lines: Array<string>): string
  ...
  export function addCustomMessageFileInclude(input: string, packager: PlatformPackager<any>, isMultiLang: boolean): Promise<string>
}
...
declare module "electron-builder/out/targets/nsis/nsisLicense" {
  ...
  export function computeLicensePage(packager: WinPackager, options: NsisOptions): Promise<string | null>
}
...
declare module "electron-builder/out/winPackager" {
  import { Arch, Lazy } from "electron-builder-util"
  import { Platform, Target } from "electron-builder/out/core"
  ...
  export class WinPackager extends PlatformPackager<WinBuildOptions> {
    ...
    signAndEditResources(file: string, arch: Arch, outDir: string, internalName?: string | null): Promise<void>
...
declare module "electron-builder/out/builder" {
  ...
  import { Platform } from "electron-builder/out/core"
  import { PackagerOptions } from "electron-builder/out/packagerApi"
...
declare module "electron-builder" {
  ...
  export { Platform, Target, DIR_TARGET } from "electron-builder/out/core"
